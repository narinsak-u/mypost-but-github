...
export function LoginModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="sm:max-w-100 bg-[#161B22] border-[#30363D] text-[#C9D1D9] [&>button]:hidden">
        <DialogTitle></DialogTitle>
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-[#0D1117] border border-[#30363D]">
            <TabsTrigger
              value="sign-in"
              className="data-[state=active]:bg-[#1F6FEB] data-[state=active]:text-white text-[#8B949E]"
            >
              Sign In
            </TabsTrigger>
            <TabsTrigger
            ...
            <form onSubmit={handleSignIn} className="space-y-4 mt-3">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className="bg-[#0D1117] border-[#30363D] text-[#C9D1D9] placeholder:text-[#484F58] focus-visible:ring-[#1F6FEB]"
                />
              </div>
              <div className="space-y-2">
                <Label
        ...
        <div className="grid grid-cols-2 gap-3">
          <Button
            ...
            disabled={loading}
            className="border-[#30363D] bg-[#0D1117] text-[#C9D1D9] hover:bg-[#21262D] hover:text-white"
          >
